...
public class OrderService {
        ...
        if (Constants.ok.equals(result)) {
            ...
            try {
                ...
                saveResult = jpaClient
                        .saveOrUpdateOrder(JSON.toJSONString(order));
            ...
            if (pushResult == null
                    || !"0".equals(pushResult.getString("code"))) {
    ...
    public void newOrderPush(String shopId, @Valid NewOrderBean newOrderBean) {
        ...
        pushOrder.setDeliverTime(newOrderBean.getDeliveryTime() == 0 ? ""
                : sdf.format(new Date(newOrderBean.getDeliveryTime() * 1000)));
    ...
    public void refundOrderConfirm(String shopId, Long orderId, String reason) {
        ...
        String result = "";
        try {
            logger.info("refundOrderConfirm request = {}",
    ...
    public void refundOrderRefuse(String shopId, Long orderId, String reason) {
        ...
        String result = "";
        try {
            logger.info("refundOrderRefuse request = {}",
                    JsonFormatUtil.toJSONString(request));
            result = request.doRequest();
